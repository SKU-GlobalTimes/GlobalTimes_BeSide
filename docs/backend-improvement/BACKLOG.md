...
### P1 연동 후속. News API·Google Trends 소규모 실호출 설정

- 상태: `Done` ([#249](https://github.com/SKU-GlobalTimes/GlobalTimes_BeSide/issues/249), [PR #250](https://github.com/SKU-GlobalTimes/GlobalTimes_BeSide/pull/250))
